<template>
  <q-page>
    ...
    <article>
      ...
      <h6 id="m13">Maßgebliche Rechtsgrundlagen</h6>
      <p>
      ...
      <h5 id="m134">Einsatz von Cookies</h5>
      <p>
      ...
      <h5 id="m367">Registrierung, Anmeldung und Nutzerkonto</h5>
      <p>
        ...
        E-Mail-Adresse). Die im Rahmen der Registrierung eingegebenen Daten
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>Zwecke der Verarbeitung:</strong> Vertragliche Leistungen und
      ...
      <h5 id="m136">Präsenzen in sozialen Netzwerken</h5>
      <p>
      ...
      <p>
        ...
        unter dem Privacy-Shield zertifiziert sind oder vergleichbare Garantien
        eines sicheren Datenschutzniveaus bieten, weisen wir darauf hin, dass
      ...
      <h5 id="m12">Löschung von Daten</h5>
      <p>
