  ...
  <q-page>
    ...
    <article>
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>Twitter:</strong> Soziales Netzwerk; Dienstanbieter:
      ...
      <ul className="m-elements">
        <li>
          ...
          besuchte Webseiten, Interesse an Inhalten, Zugriffszeiten),
          Meta-/Kommunikationsdaten (z.B. Geräte-Informationen,
          IP-Adressen), Standortdaten (Daten, die den Standort des Endgeräts
          eines Endnutzers angeben).
        </li>
        <li>
          <strong>Betroffene Personen:</strong> Nutzer (z.B.
          Webseitenbesucher, Nutzer von Onlinediensten).
      ...
      <h5 id="m15">Änderung und Aktualisierung der Datenschutzerklärung</h5>
      <p>
