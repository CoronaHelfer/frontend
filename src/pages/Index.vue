    ...
    <q-page-container>
      <q-page class="flex flex-center">
        <div class="StartPage">
          ...
          <p>
            Wie ist unsere Idee entstanden? Über soziale Netzwerke sind wir
            darauf aufmerksam geworden, wie unfassbar viele von euch in ihrer
            Umgebung Hilfe angesichts der aktuellen Situation anbieten möchten.
            Bei anderen Vermittlungsportalen fiel uns die große Anzahl an
            hilfsbereiten Menschen im Gegensatz zu nur wenigen Anfragen auf.<br /><br />
            Wir haben erkannt, dass die Vermittlung von Fremden an Fremde eine
            große Herausforderung darstellt und machten uns die Sicherheit
            unserer Nutzer zur Aufgabe. Auch eine verlässliche und schnelle
            Vermittlung sowie die Einbindung bereits bestehender Offline-Arbeit
            vor Ort sind uns bei der Coronavirus-Nachbarschaftshilfe wichtig.<br /><br />
